...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        cardDetail.setBounds(130, 330, 300, 20);
        add(cardDetail);
        ...
        pinDetail.setBounds(130, 400, 300, 20);
        add(pinDetail);

        JLabel pnumber = new JLabel("XXXX");
        pnumber.setFont(new Font("Raleway", Font.BOLD, 22));
        pnumber.setBounds(360, 370, 300, 30);
        add(pnumber);

        JLabel services = new JLabel("Services Required:");
        services.setFont(new Font("Raleway", Font.BOLD, 22));
        services.setBounds(130, 450, 300, 20);
        add(services);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            if (c4.isSelected()) facility.append(" EMAIL & SMS Alert");
            ...
            try {
                if (accountType == null) {
                    ...
                    String query1 = "insert into signupThree values('" + formno + "', '" + accountType + "', '"
                            + cardNumber + "', '" + pinNumber + "', '" + facility.toString().trim() + "')";
